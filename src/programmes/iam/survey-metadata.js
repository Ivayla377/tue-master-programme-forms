...
export function registerCourseChoiceMetadata(Serializer) {
  if (!Serializer || typeof Serializer.findProperty !== "function" || typeof Serializer.addProperty !== "function") {
    return;
  }

  if (Serializer.findProperty("itemvalue", COURSE_CHOICE_CREDITS_PROPERTY)) return;
